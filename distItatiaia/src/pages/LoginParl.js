...
function LoginParl() {
    const { CreateSession, idSession, error, setError } = (0, react_1.useContext)(AuthProvider_1.AuthContext);
    ...
    const parl = localStorage.getItem('novace@userParl');
    (0, react_1.useEffect)(() => {
        ...
        if (!token && !parl) {
            ...
            navigate('/parlamentar/acesso/votacao');
        }
    ...
    return (react_1.default.createElement("div", { className: "flex px-10 justify-items-center h-screen " },
        react_1.default.createElement("div", { className: "flex flex-col items-center gap-4 justify-center mx-auto " },
            react_1.default.createElement("img", { className: "hidden sm:flex w-70", src: "/novace_logo.png", alt: "Logo Novace" })),
        react_1.default.createElement("div", { className: "flex min-h-full flex-col justify-center  py-12 sm:px-12 sm:border-l-2 " },
            react_1.default.createElement("div", { className: "sm:mx-auto sm:w-full sm:max-w-sm" },
                ...
                react_1.default.createElement("h2", { className: "mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900" }, "Parlamentar acesse a \u00E1rea de Vota\u00E7\u00E3o!")),
            react_1.default.createElement("div", { className: "mt-10 sm:mx-auto sm:w-full sm:max-w-sm" },
                ...
                react_1.default.createElement("div", { className: "flex mt-20 " },
                    react_1.default.createElement("a", { href: "/", className: "text-cyan-400 hover:text-cyan-500 underline" }, "Acesso Administrador Aqui"))))));
}
exports.default = LoginParl;
