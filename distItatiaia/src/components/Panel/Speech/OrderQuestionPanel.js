...
exports.OrderQuestionPanel = void 0;
const react_1 = __importStar(require("react"));
const AuthProvider_1 = require("../../../contexts/AuthProvider");
function OrderQuestionPanel({ dados }) {
    const { PatchSpeechParl, getIdSpeech, GetIdSpeech } = (0, react_1.useContext)(AuthProvider_1.AuthContext);
    const [totalTimeInSeconds, setTotalTimeInSeconds] = (0, react_1.useState)(dados?.speechParl?.orderQuestionTimeInit); //10*60 10 minutes
    ...
    return (react_1.default.createElement("div", { className: "flex flex-col" },
        react_1.default.createElement("span", { className: "text-xl font-bold" }, "Quest\u00E3o de Ordem"),
...
exports.OrderQuestionPanel = OrderQuestionPanel;
