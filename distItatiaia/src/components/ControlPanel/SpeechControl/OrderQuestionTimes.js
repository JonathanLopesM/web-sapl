...
exports.OrderQuestionTimes = void 0;
const react_1 = __importStar(require("react"));
const AuthProvider_1 = require("../../../contexts/AuthProvider");
function OrderQuestionTimes() {
    ...
    const [totalTimeInSeconds, setTotalTimeInSeconds] = (0, react_1.useState)(1 * 60); //dados?.data?.speechParl?.orderQuestionTimeInit)
...
exports.OrderQuestionTimes = OrderQuestionTimes;
