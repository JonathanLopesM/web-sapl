...
exports.ResultVote = void 0;
const react_1 = __importStar(require("react"));
const AuthProvider_1 = require("../../../contexts/AuthProvider");
function ResultVote({ setMatterState, sessionId, setProjectsView }) {
    const { MatterUpdated, GetVotes, resultVote, voteResParl, votes, setVotes, matterComplet, CloseVote, Matters, PatchVotePar, ReloadVotePanel, RegisterVoteSapl } = (0, react_1.useContext)(AuthProvider_1.AuthContext);
    (0, react_1.useEffect)(() => {
        if (!resultVote) {
            GetVotes();
        }
    ...
    const [resultVoteForm, setResultVoteForm] = (0, react_1.useState)(resultVote && resultVote?.Yes > resultVote?.Not ? 2 : 4);
        ...
        react_1.default.createElement("div", { className: "flex flex-col border p-8 mt-[55px] overflow-auto" },
            ...
            react_1.default.createElement("div", null,
                react_1.default.createElement("div", { className: " my-5" },
                    ...
                    react_1.default.createElement("ul", { className: "flex flex-col gap-2" }, voteResParl && voteResParl.map(parl => (react_1.default.createElement(react_1.default.Fragment, null, parl.presenca && react_1.default.createElement("li", { key: parl.id, className: "flex gap-8 text-center items-center w-[500px] justify-between" },
                        parl.name,
                        react_1.default.createElement("div", { className: "flex gap-4" },
                            !parl.presenca ?
                                react_1.default.createElement("span", { className: "flex text-red-400" }, "Ausente")
                                : react_1.default.createElement("span", { className: "flex text-green-400" }, "Presente"),
                            !parl.presenca
                                ?
