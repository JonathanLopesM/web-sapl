...
export default function LoginParl() {
  const { CreateSession, idSession, error, setError } = useContext(AuthContext)
  ...
  return (
    <div className="flex px-10 justify-items-center h-screen ">
      <div className="flex flex-col items-center gap-4 justify-center mx-auto ">
          <img className="hidden sm:flex w-70" src="/novace_logo.png" alt="Logo Novace" />
        </div>
        <div className="flex min-h-full flex-col justify-center  py-12 sm:px-12 sm:border-l-2 ">
          <div className="sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">
              Parlamentar acesse a área de Votação!
            </h2>
          </div>
          ...
          <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <div className="flex mt-20 ">
              <a href="/" className="text-cyan-400 hover:text-cyan-500 underline">
                Acesso Administrador Aqui
              </a>
            </div>
          </div>
        </div>
